...
<?php
    ...
    $sentencia = $bd -> query("select * from clinica.cita");
    $persona = $sentencia->fetchAll(PDO::FETCH_OBJ);
?>
<?php include 'convertirTextoImagen.php'?>
    <main class="main">
        <div class="main-input">
            <form action="registrar.php" method="POST">
                ...
                <div class="input-contenedor">
                    ...
                    <input class="input" type="date" name="txtDate">
                </div>
            ...
            <table>
                <thead>
                    <tr class="registro-fila">
                        ...
                        <th class="registro-fila-6">Fecha</th>
                ...
                <tbody>
                    ...
                    <tr class="registro-fila">
                        ...
                        <td class=registro-fila-6><?php echo $dato->date; ?></td>
